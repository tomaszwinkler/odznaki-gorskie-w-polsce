...
Aplikacja (PWA) do śledzenia postępu w zdobywaniu polskich odznak turystycznych: **GOT**, **Korona Gór Polski**, **Diadem Polskich Gór**, **Korona Najwybitniejszych Szczytów Gór Polskich**, **Korona Sudetów**, **Korona Beskidów**, **Wielka Korona Beskidów**, **Turystyczna Korona Tatr**, **Korona Bieszczadów**, **Dominanty Przedgórza Sudeckiego**, **Korona Polskich Beskidów** i **Mała Korona Beskidów**. Pozwala oznaczać odwiedzone szczyty, prowadzić dziennik wypraw ze zdjęciami i importem tras GPX oraz przeglądać punkty na liście i interaktywnej mapie.

## Funkcje

- **Dwanaście systemów odznak** pogrupowanych w kategorie (odznaki ogólnopolskie, korony makroregionalne, odznaki regionalne):
