...
Aplikacja (PWA) do śledzenia postępu w zdobywaniu polskich odznak turystycznych: **GOT**, **Korona Gór Polski**, **Diadem Polskich Gór**, **Korona Najwybitniejszych Szczytów Gór Polskich**, **Korona Sudetów**, **Korona Beskidów**, **Wielka Korona Beskidów**, **Turystyczna Korona Tatr**, **Korona Bieszczadów**, **Dominanty Przedgórza Sudeckiego**, **Korona Polskich Beskidów**, **Mała Korona Beskidów**, **Korona Gór Świętokrzyskich**, **Tatrzańskie Dwutysięczniki**, **Bieszczadzkie Tysięczniki** i **Tysięczniki Ziemi Kłodzkiej**. Pozwala oznaczać odwiedzone szczyty, prowadzić dziennik wypraw ze zdjęciami i importem tras GPX oraz przeglądać punkty na liście i interaktywnej mapie.

## Funkcje

- **Szesnaście systemów odznak** pogrupowanych w kategorie (odznaki ogólnopolskie, korony makroregionalne, odznaki regionalne):
  ...
  - **Tatrzańskie Dwutysięczniki** (Hutniczo-Miejski Oddział PTTK w Krakowie, 2015) — 55 szczytów i przełęczy powyżej 2000 m po polskiej i słowackiej stronie Tatr, trzy stopnie (brązowy 20, srebrny 35, złoty 55). 44 pozycje wspólne z Turystyczną Koroną Tatr, GOT i Diademem, 11 nowych z orientacyjnymi współrzędnymi (przy większości jedno źródło). Szlaki po stronie słowackiej są zamknięte zimą, a przy części szlak biegnie obok, a nie przez wierzchołek — wykaz dopuszcza „w pobliże”
  - **Bieszczadzkie Tysięczniki** (Łukasz Kornatka, od 2020) — 40 szczytów powyżej 1000 m ze znakowanym szlakiem na szczycie lub tuż obok, osiem stopni co 5 szczytów (od 5 do 40). 15 szczytów wspólnych z Koroną Bieszczadów, GOT i innymi, 25 nowych z orientacyjnymi współrzędnymi. Kilka nazw w wykazie jest niejednoznacznych (np. dwa „Bukowe Berdo”, Czerteż, Szeroki Wierch/Tarniczka) — zidentyfikowano je wg wysokości i pasma. „Połonina Wetlińska (Hasiakowa Skała)” to inny szczyt niż Roh i Smerek
  - **Tysięczniki Ziemi Kłodzkiej** (Oddział PTTK „Ziemi Kłodzkiej”) — 32 szczyty powyżej 1000 m w Górach Sowich, Orlickich, Masywie Śnieżnika i Górach Bialskich. Współrzędne pochodzą z wykazu w regulaminie. To głównie szczyty bez szlaku lub z szlakiem obok, dlatego w danych tras jest „brak danych” dla czasów przejścia i przewyższeń, a przy wielu szczytach źródła się różnią co do przebiegu szlaku
